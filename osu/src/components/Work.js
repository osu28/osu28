    ...
    return (
      <div>
        <div className="work_description">
          ...
          <p>I enjoy working on projects with a sizable impact. One of my most memorable experiences was using AR and ML to allow users to track objects behind walls (irl wall hack). Here’s the demo vid.</p>
